...
export const TrainingCard = ({ routine }) => {
  ...
  useEffect(() => {
    if (routine.exercises && routine.compare_date.length > 0) {
      const firstExercise = routine.compare_date[0];
            ...
            <Box>
              ...
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
                ...
                {routine.exercises && routine.exercises.length > 0 ? (
                  ...
                  [
                    ...new Set(
                      routine.compare_date.flatMap((exercise) =>
                ...
                {routine.exercises && routine.completed_at.length > 0
                  ? routine.completed_at.map((exercise, index) => (
                      <Chip
                        key={index}
                        label={exercise.name}
                        variant="outlined"
