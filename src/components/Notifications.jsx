...
import { mockNotifications } from "../controllers/FakeExercise.js";
...
function Notifications() {
  ...
  useEffect(() => {
    ...
    // Mock real-time subscription (simulated with a timer for new notifications)
    ...
    }, 300000); // Simulate a new notification every 30 seconds
